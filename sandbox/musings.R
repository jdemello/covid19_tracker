...
cntrys <- c("Australia", "Brazil","Canada", "China", "France", "Germany", "India", 
            "Italy", "Japan", "Netherlands", "South Korea", "Spain", "United Kingdom", "US")
...
d1 <- data[country %in% cntrys, ][
  ...
  # plot params parameters
    # last updated object
maxDate <- format(d1[, max(date)], "%B %d, %Y")
